...
showVenderAddDocumentPopup(BuildContext context, Function(Document) onAdd) {
  showGeneralDialog(
    context: context,
    pageBuilder: (ctx, a, aa) => AddDocumentBox(
      onAdd: onAdd,
    ),
  );
}
...
class AddDocumentBox extends StatefulWidget {
  Function(Document) onAdd;
  AddDocumentBox({Key? key, required this.onAdd}) : super(key: key);
